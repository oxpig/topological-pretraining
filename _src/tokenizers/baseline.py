...
_descriptors: list[str] = [
    ...
    'BCUT2D_LOGPHI', 'BCUT2D_LOGPLOW', 'BCUT2D_MRHI', 'BCUT2D_MRLOW', 'AvgIpc',
...
no_variance_in_standardized_qmugs = [
    'NumRadicalElectrons', 'SMR_VSA8', 'SlogP_VSA9',
    'fr_diazo', 'fr_prisulfonamd'
]

regression_descriptors = [
    # general
...
# which need log transformation: MolMR, MolWt, ExactMolWt
# (choose between MolWt, ExactMolWt, and HeavyAtomMolWt)
...
count_descriptors = [
    ...
    'fr_benzene','fr_benzodiazepine','fr_bicyclic',
    ...
    'fr_priamide','fr_pyridine','fr_quatN',
